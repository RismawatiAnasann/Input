	...
	{ 
		...
		elseif(!preg_match($pattern,$email))		
			...
			$noemail=1;		
		       ...
		       {
			   $query= "insert into Formulir (nama,alamat,kota,provinsi,email,komentar) 
...
<tr><td>
<center><b><marquee><font face="elephant" color="#FFFFFF" size="5">Formulir Regristrasi</font></b></marquee></center></tr>
